jQuery(document).on('ready', function ($) {
    ...
    /*------------------------------
        VIDEO POPUP
    --------------------------------*/
    var $videoModal = $(".video-area-popup,.post-video-popup");
	...
	-----------------------------*/
    var portfolioGallerySlider = $('.portfolio-gallery-slider');
    if (portfolioGallerySlider.length > 0) {
        portfolioGallerySlider.owlCarousel({
            merge: true,
            smartSpeed: 1000,
            loop: true,
            nav: true,
    ...
    /*---------------------------
        POST GALLERY SLIDER
    -----------------------------*/
    var galleryCarousel = $('.posts-gallery');
